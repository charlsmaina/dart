class Student {
  ...
  /* USe of named constuctors */
  Student.noCollege(this.name, int age_value) {
    this.age = age_value; /* a setter by name of age is used to set the age */
...
void main() {
  ...
  s.venue();
  s._age =
      25; // dart private attibutes and properties are enforced at file scope not class scope.
